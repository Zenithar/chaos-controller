...
- [Out of pods disruptions](/docs/out_of_pods.md)
  - [I want to prevent new pods from scheduling on a node](../examples/out_of_pods.yaml)
  - [I want to evict pods and prevent scheduling on a node](../examples/out_of_pods_forced.yaml)
