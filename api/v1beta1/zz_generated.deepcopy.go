...
func (in *DisruptionSpec) DeepCopyInto(out *DisruptionSpec) {
	*out = *in
	...
	if in.OutOfPods != nil {
		in, out := &in.OutOfPods, &out.OutOfPods
		*out = new(OutOfPodsSpec)
		**out = **in
	}
	if in.Reporting != nil {
		in, out := &in.Reporting, &out.Reporting
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OutOfPodsSpec) DeepCopyInto(out *OutOfPodsSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OutOfPodsSpec.
func (in *OutOfPodsSpec) DeepCopy() *OutOfPodsSpec {
	if in == nil {
		return nil
	}
	out := new(OutOfPodsSpec)
